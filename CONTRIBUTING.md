...
This repository is the Go daemon client for Kryptic (`github.com/dev-kryptic/Kryptic.Go`).
...
the Kryptic Release Bot, publishes to pkg.go.dev, tags `vX.Y.Z`, and opens a
